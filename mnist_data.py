...
def mnist():
    ...
    Trainimages = DataUtils(filename=trainfile_X).getImage()
    Trainlabels = DataUtils(filename=trainfile_y).getLabel()
    Testimages = DataUtils(testfile_X).getImage()
    Testlabels = DataUtils(testfile_y).getLabel()
